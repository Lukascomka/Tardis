...
btn.forEach((button) => {
	button.addEventListener('click', () => {
		pesquisar.forEach((item) => item.classList.contains('active') ? item.classList.remove('active') : null);
...
cols.forEach((col) => {
  col.addEventListener('click', () => {
    cols.forEach((item) => item.classList.contains('active') ? item.classList.remove('active') : null);
...
buttonm.forEach((button) => {
	button.addEventListener('click', () => {
	buttonm.forEach((item) => item.classList.contains('active') ? item.classList.remove('active') : null);
